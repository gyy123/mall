...
<html>
  <head>
    ...
    <title>My JSP 'top_nologin.jsp' starting page</title>
  ...
  <tr>
    <td>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="pagetop">
        <tr>
          <td width="381"><img src="foreground/img/logo.jpg" width="368" height="94" alt="logo"></td>
          <td width="10" align="right" valign="top" class="help">&nbsp;</td>
          <td width="384" align="right" valign="top" class="help"><br/>
            <br/>
            	<b><div id="it"></div></b>		
            <br/>
            [<a href="foreground/login.jsp" target="_parent">用户登录</a>]
            &nbsp;|&nbsp;
            [<a href="foreground/register.jsp" target="_parent">免费注册</a>] </td>
        </tr>
      </table>
                ...
                <td class="menuMain1"><table width="767" border="0" cellpadding="0" cellspacing="0">
                    <tr align="center">
                      ...
                      <td width="60" class="menuLinkbg">
                      	<a href="javascript:location.go(0)" onclick="alert('对不起，您还没有登录，不能查看个人信息！')" class="menuLink" target="_parent">我的信息</a></td>
                      <td width="60" class="menuLinkbg">
