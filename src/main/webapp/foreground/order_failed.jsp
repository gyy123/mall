...
<html>
  <head>
    ...
    <title>My JSP 'order_failed.jsp' starting page</title>
  ...
  <body><center>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="yrh">
	  <tr>
	    <td><a href="cart_list.htm"></a> 购物车&raquo; <a href="order_confirm.htm">确认订单</a>&raquo;订单提交确认信息</td>
	  </tr>
	</table>
	  ...
	  <tr valign="top">
	    <td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="inputTable">
			  <tr>
			    <td class="inputTitle">订单提交失败信息</td>
			  </tr>
			  <tr>
			    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			        <tr>
			          <td align="center" class="inputContent"><H3>对不起，由于系统原因，您的订单提交失败，请返回重新操作，谢谢！</H3></td>
			        </tr>             
					<tr>
