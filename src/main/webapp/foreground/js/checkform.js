...
if(document.form1.name.value===""){
	document.getElementById("name2").innerHTML="<font size='2' color='red'>用户名不能为空</font>";
	document.form1.name.focus();
	return false;}
if(document.form1.password.value===""){
document.getElementById("pw").innerHTML="<font size='2' color='red'>密码不能为空</font>";
document.form1.answer.focus();
return false;
}
if(!checkEmail(document.form1.email.value)){
document.getElementById("email2").innerHTML="<font size='2' color='red'>邮箱格式不正确</font>";
document.form1.email.focus();
return false;
}
/*if(document.form1.password2.value.length<6||document.form1.password.value<6){
...
document.form1.phone.focus();
return false;
}if(!checkTel(document.form1.tel.value)){
 window.alert("手机号码格式不对！");
