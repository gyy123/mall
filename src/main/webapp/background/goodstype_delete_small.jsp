...
<html:form action="category.do?service=querySubAll_del">
<div id="main">
	<div id="header">
		...
		<div id="center-column">
			<div class="top-bar">
			  <h1>删除商品小分类</h1>
				<div class="breadcrumbs">
					<a href="background/goodstype_index.jsp">商品类型管理</a> / <a href="background/goodstype_delete_small.jsp">删除小分类</a>
				</div>
		  </div><br />
		  ...
		  <div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						<th width="177">商品分类编号</th>
						<th width="177">商品小分类名称</th>
						<th>商品上级分类</th>
						<th>商品分类级别</th>
						<th class="last">删除</th>
					</tr>
					<logic:iterate id="all_all" name="sub_all_del">
					<tr>
						...
						<td class="last"><html:link page="/category.do?service=deleteCategory_small" paramId="b_cate" paramName="all_all" paramProperty="id"><img src="background/img/hr.gif" width="16" height="16" alt=""/></html:link></td>
					</tr>
					</logic:iterate>
				</table>
				<div class="table">
