...
<div id="main">
	...
	<div id="middle">
	  ...
	  <div id="center-column">
	    <div class="top-bar">
          <h1>新闻管理</h1>
	      <div class="breadcrumbs"><a href="news.html">新闻管理</a>/<a href="information.html">资讯管理</a>/<a href="information_add.html">添加</a></div>
        </div>
	    <br />
	    <div class="table"> <img src="background/img/bg-th-left.gif" width="8" height="7" alt="" class="left" /><img src="background/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
            	<html:form action="news.do?post=addInformation">
            	<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">添加咨询</th>
					</tr>
					<tr>
						<td class="first style1" width="172"><strong>资讯名称：</strong></td>
						<td class="last"><html:text property="title"/></td>
					</tr>
					<tr class="bg">
						<td class="first style1"><strong>资讯内容：</strong></td>
						<td class="last"><html:textarea property="content" cols="70" rows="4"></html:textarea>
						</td>
					</tr>
					<tr>
