...
function SelectDate(obj,strFormat){
    var date = new Date();
    var by = 1990; //最小值1990年
    var ey = 2025; //最大值2025年
...
mvAry[mvAry.length] = '      <tr style="align:right;background-color:' + calendar.colors["input_bg"] + ';">';
mvAry[mvAry.length] = '        <th colspan="5"><input name="calendarClear" type="button" id="calendarClear" value="' + Calendar.language["clear"][this.lang] + '" style="border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:100%;height:20px;font-size:12px;"/></th>';
