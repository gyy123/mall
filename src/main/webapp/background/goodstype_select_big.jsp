...
<html:form action="category.do?service=queryMainAll">
<div id="main">
	<div id="header">
			...
			<div class="top-bar">
			  <h1>查询商品大分类</h1>
				<div class="breadcrumbs">
					<a href="background/goodstype_index.jsp">商品类型管理</a> / <a href="background/goodstype_select_big.jsp">查询大分类</a>
				</div>
			</div><br />
	      ...
	      <table>
			...
			<div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					...
					<logic:iterate id="main_all_1" name="main_sel">
					<tr>
