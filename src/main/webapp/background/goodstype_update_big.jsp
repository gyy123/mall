...
<body>
<html:form action="category.do?service=queryMainAll_up">
<div id="main">
	<div id="header">
		<a href="index.jsp" class="logo"><img src="img/logo.jpg" width="160" height="50" alt="" /></a>
	  ...
	  <div id="center-column">
			<div class="top-bar">
			  <h1>修改商品大分类</h1>
				<div class="breadcrumbs">
					<a href="background/goodstype_index.jsp">商品类型管理</a> / <a href="background/goodstype_update_big.jsp">修改大分类</a>
				</div>
			</div><br/>
			...
			<div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						<th>商品分类编号</th>
						<th width="277">商品分类名称</th>
						<th>商品分类级别</th>
						<th>修改</th>
						<th class="last">删除</th>
					</tr>
					
					<logic:iterate id="main_all_1" name="main_up">
					<tr>
						<td><bean:write name="main_all_1" property="id"/></td>
						<td><bean:write name="main_all_1" property="name"/></td>
						<td><bean:write name="main_all_1" property="type"/></td>
						...
						<td class="last"><html:link page="/category.do?service=deleteCategory" paramId="b_cate" paramName="main_all_1" paramProperty="id"><img src="background/img/hr.gif" width="16" height="16" alt=""/></html:link></td>
					</tr>
					</logic:iterate>
				</table>	
				<div class="table">
