...
<html:form action="category.do?service=querySubAll">
<div id="main">
	<div id="header">
		...
		<div id="center-column">
			<div class="top-bar">
			  <h1>查询商品小分类</h1>
				<div class="breadcrumbs">
					<a href="background/goodstype_index.jsp">商品类型管理</a> / <a href="goodstype_select_big.jsp">查询小分类</a>
				</div>
			</div><br />
		  ...
		  <div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					...
					<logic:iterate id="all_all" name="sub_sel">
					<tr>
