...
<html:form action="category.do?service=queryMainAll_del">
<div id="main">
	<div id="header">
		...
		<div id="center-column">
		  ...
		  <div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						<th width="77">商品分类编号</th>
						<th width="177">商品大分类名称</th>
						<th class="last">删除</th>
					</tr>
					<logic:iterate id="all_all" name="main_all_del">
					<tr>
						<td><bean:write name="all_all" property="id"/></td>
						<td><bean:write name="all_all" property="name"/></td>
						<td class="last"><html:link page="/category.do?service=deleteCategory_big" paramId="b_cate" paramName="all_all" paramProperty="id"><img src="background/img/hr.gif" width="16" height="16" alt=""/></html:link></td>
					</tr>
					</logic:iterate>
