...
<html:form action="admin.do?service=updatePriority&name=${querytemp.name}">
	  ...
	  <div id="center-column">
			...
			<div class="table">
				...
				<table width="387" cellpadding="0" cellspacing="0" class="listing">
					...
					<tr>
						<td class="first style1"><bean:write name="querytemp" property="name"/></td>
						
						<td>
						
						
						<table>
						               <html:checkbox  value="1"name="querytemp" property="product_do" >商品的增加、删除、修改、查询</html:checkbox><br/>
						               <html:checkbox  value="1"name="querytemp" property="product_category_do">商品分类的增、删、改、查</html:checkbox><br/>
						               <html:checkbox  value="1"name="querytemp" property="news_do">首页公告的修改，咨询的管理</html:checkbox><br/>
						               <html:checkbox  value="1"name="querytemp" property="user_do">用户密码和详细资料的查询，删除用户</html:checkbox><br/>
						               <html:checkbox  value="1"name="querytemp" property="order_do">对历史订单的查询，修改</html:checkbox><br/>
					...
					<tr >
					<td colspan="3"><html:image src="background/img/dd1.png" ></html:image></td>
					</tr>
