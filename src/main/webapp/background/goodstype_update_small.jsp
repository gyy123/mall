...
<body>
<html:form action="category.do?service=querySubAll_up">
<div id="main">
	<div id="header">
		...
		<div id="center-column">
			<div class="top-bar">
			  <h1>修改商品小分类</h1>
				<div class="breadcrumbs">
					<a href="background/goodstype_index.jsp">商品类型管理</a> / <a href="background/goodstype_update_small.jsp">修改小分类</a>				
				</div>
		  	</div><br />
		  	<div class="select-bar">
	      			
	        		请输入要修改的小分类名称：
	        		<html:text property="cname"></html:text>
			...
			<div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					...
					<logic:iterate id="all_all" name="sub_up">
					<tr>
