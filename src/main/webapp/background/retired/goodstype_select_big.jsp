			...
			<div class="top-bar">
			  <h1>查询商品大分类</h1>
				<div class="breadcrumbs">
					<a href="goodstype_index.html">商品类型管理</a> / <a href="goodstype_select_big.html">查询大分类</a>
				</div>
			</div><br />
		  	<div class="select-bar">
	      <form id="form1" name="form1" method="post" action="">
	        请输入要查询的大分类名称：<input type="text" name="textfield" />
		    <img src="img/search.gif" width="60" height="22" align="absmiddle" />
    	  </form>
        </div>
			<div class="table">
