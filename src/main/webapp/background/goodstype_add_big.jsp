...
<head>
	...
	<style media="all" type="text/css">@import "background/css/all.css";
	</style>
...
<body onload="showhead();show();">
	<html:form action="category.do?service=addMainCategory">
	<div id="main">
		<div id="header">
			<a href="index.jsp" class="logo"><img width="160" height="50"
					src="background/img/logo.jpg" alt="" />
			</a><a href="index.jsp" class="logo"></a>
		...
		<div id="middle">
			...
			<div id="center-column">
				<div class="top-bar">
					...
					<div class="breadcrumbs">
						<a href="/ccMall_gj3_g9/category.do?service=queryAll">商品类型管理</a> /
						<a href="background/goodstype_add_big.jsp">添加大分类</a>
					</div>
				</div>
				<br />
				...
				<div class="table">
					<img src="background/img/bg-th-left.gif" width="8" height="7"
						alt="" class="left" />
					<img src="background/img/bg-th-right.gif" width="7" height="7"
						alt="" class="right" />
					<table class="listing" cellpadding="0" cellspacing="0">
						...
						<logic:iterate id="main_all_1" name="main_all_add">
							<tr>
								<td>
									<bean:write name="main_all_1"property="id" />
								</td>
								<td>
									<bean:write name="main_all_1" property="name" />
								</td>
								<td><html:link page="/category.do?service=queryCategory_byId" paramId="a_cate" paramName="main_all_1" paramProperty="id"><img src="background/img/edit-icon.gif" width="16" height="16" alt=""/></html:link></td>
			...
			<div id="right-column">
				...
				<div class="box">
					<font color="#FF7A00">北京时间：</font><div id="ithead"></div><div id="itdetail"></div><div id="it"></div>
				</div>
			</div>
		</div>
		<div id="footer"></div>
