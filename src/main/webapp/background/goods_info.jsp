	...
	<div id="middle">
	  ...
	  <div id="left-column">
            ...
            <ul class="nav">
				...
				<li class="last"><a href="background/goods_sellout.jsp">查询脱销商品</a></li>
			</ul> </div>                                    
      </div>
	  ...
	  <div id="center-column">
			<div class="top-bar">
			  <h1>商品详细信息</h1>
				<div class="breadcrumbs"><a href="background/goods_index.jsp">商品管理</a> / <a href="background/goods_info.jsp">商品详细信息</a></div>
			</div><br />
			...
			<div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td><bean:write name="goods_info" property="name"/></td>
						
					</tr>
					<tr class="bg">
						<td class="first style1">大分类</td>
						<td><bean:write name="goods_info" property="main_category"/></td>
						
					</tr>
					<tr>
						<td class="first style1">小分类</td>
						<td><bean:write name="goods_info" property="sub_category"/></td>
						
					</tr>
					<tr class="bg">
						<td class="first style1">商品单价</td>
						<td><bean:write name="goods_info" property="price"/></td>
						
					</tr>
					<tr>
						<td class="first style1">计量单位</td>
						<td><bean:write name="goods_info" property="unit"/></td>
						
					</tr>
					<tr class="bg">
						<td class="first style1">库存数量</td>
						<td><bean:write name="goods_info" property="num"/></td>
						
					</tr>
					<tr>
						<td class="first style1">商品描述</td>
						<td>
							<bean:write name="goods_info" property="description"/>
						</td>
					...
					<tr class="bg">
						...
						<td>
						 	<select name="goods_info" property="recommend">
					...
					<tr align="center">
						<td class="first style1" >商品评论</td>
				  	  	<td align="center">
				  	  		<a href="/ccMall_gj3_g9/comment.do?method=queryComment_pro&product_seq=${goods_info.product_SEQ}">查询评论</a>
				  	  	</td> 
					</tr>
				</table>
